...
const functions = {
  ...
  orderTotal(order) {
    ...
    order.items.forEach((e) => {
      if (e.name !== 'Tax') {
        somme = somme + e.price * e.quantity;
      } else {
  ...
  // Takes a string, find the first consecutively repeating character in it
  // and return the last index of the repeated character.
  // If there are no repeating characters, return -1.
  // This function should ignore any spaces and should be case insensitive - treat 'a' as
  // eqivalent to 'A'
